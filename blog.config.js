...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '8a24f8eb0300424caa2c3f128287a970?v=bb767b833232495c992adcd7284e45b5',
  ...
  AUTHOR: 'nightwishhy', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://www.baidu.com', // 网站地址
  KEYWORDS: 'Notion, 博客,骑行', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'nightwish.hy@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/nightwishhy', // 你的github个人主页
